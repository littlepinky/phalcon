...
<div id="psw_edit">
	<form action="#" method="post" id="form1">
		<h2 class="p_edit">Get Password</h2>
        Enter the information below and we'll send you an email with  a new password.<br><br>
        Type your email address :
		<br>
		<input type="text" id="email" name="email" class="login_field">
		<br><br>

		<input type="submit" name="get" id="get" value="Submit" class="button"/>
